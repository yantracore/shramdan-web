...
// dropdown but with tabs, larger cards, and a Mark-all-read button.
// Pre-backend: data comes from getDemoNotifications() and read-state
// lives in component state only (resets on refresh).
